...
-- Venue 1
insert into Venue ( name, city, country, street, description, mediaitem_id, capacity) values ( 'SANATORIO CURUZU CUATIA', 'CURUZU CUATIA', 'CORRIENTES', 'JUAN DE VERA 765','Roy Thomson Hall is the home of the Toronto Symphony Orchestra and the Toronto Mendelssohn Choir.',4, 11000);
...
-- Venue 2
insert into Venue ( name, city, country, street, description, mediaitem_id, capacity) values ( 'SANATORIO CORRIENTES', 'MONTE CASEROS', 'CORRIENTES', 'CALLE Y NUMERO', 'The Sydney Opera House is a multi-venue performing arts centre in Sydney, New South Wales, Australia' ,3, 15030);
...
-- EventCategory 1
insert into EventCategory ( description) values ( 'PAMI');
-- EventCategory 2
insert into EventCategory ( description) values ( 'IOSCOR');
-- EventCategory 3
insert into EventCategory ( description) values ( 'SPS');
-- EventCategory 4
insert into EventCategory ( description) values ( 'OSPRERA');
-- EventCategory 5
insert into EventCategory ( description) values ( 'OSDE');
...
-- Event 1
insert into Event ( name, description, mediaitem_id, category_id) values ( 'PEREZ JUAN', 'BELGRANO 1212, CURUZU CUATIA', 1, 1);
-- Event 2
insert into Event ( name, description, mediaitem_id, category_id) values ( 'MENDOZA MARIA', 'GRAL RAMIREZ 2091', 2, 2);
-- Event 3
insert into Event ( name, description, mediaitem_id, category_id) values ( 'LOPEZ MARCELA', 'GRAL SAN MARTIN 233', 6, 4);
-- Event 4
insert into Event ( name, description, mediaitem_id, category_id) values ( 'MARCO MARCOS', 'PARADA PUCHETA', 7, 4);
-- Event 5
insert into Event ( name, description, mediaitem_id, category_id) values ( 'GARCIA LAURA', 'Every tennis enthusiast will want to see Wimbledon legend Chris Lewis as he meets archrival Deuce Wild in the quarterfinals of one of the top U.S. tournaments. Finals are already sold out, so do not miss your chance to see the real action in play on the eve of the big day!', 11, 4);
-- Event 6
insert into Event ( name, description, mediaitem_id, category_id) values ( 'MORANO JORGE', 'Join your fellow crew junkies and snarky, self-important collegiate know-it-alls from the nations snobbiest schools to see which team is in fact the fastest show on oars. (Or, if you like, just purchase a ticket and sport a t-shirt from your local community college just to tick them off -- this event promises to be SO much fun!)', 12, 4);
-- Event 7
insert into Event ( name, description, mediaitem_id, category_id) values ( 'PACE BERNARDA', 'What else is there to say? There''s snow and sun and the bravest (or craziest) guys ever to strap two feet to a board and fly off a four-story ramp of ice and snow. Who would not want to see how aerial acrobatics are being redefined by the world''s top adrenaline junkies?', 13, 4);
-- Event 8
insert into Event ( name, description, mediaitem_id, category_id) values ( 'GOMEZ LUCAS', 'Hear the sounds that have the critics abuzz. Be one of the first American audiences to experience Portuguese phenomenon Arrhythmia play all the tracks from their recently-released ''Graffiti'' -- the show includes a cameo with world-famous activist and graffiti artist Bansky.', 8, 1);
-- Event 9
insert into Event ( name, description, mediaitem_id, category_id) values ( 'ROMERO IVAN', 'That''s right -- they''ve blown into town! Join the annual tri-state Battle of the Brass Bands and watch them ''gild'' the winning band''s Most Valuable Blower (MVB) -- don''t worry (and don''t inhale!); it''s only spray paint!  Vote for your best band and revel in a day of high-energy rhythms!',  9, 1);
-- Event 10
insert into Event ( name, description, mediaitem_id, category_id) values ( 'TURTE ANTONIO', 'Sit center stage as Harlequin Ayes gives another groundbreaking theater performance in the critically acclaimed Carnival Comes to Town, a monologue re-enactment of one-woman''s despair at not being chosen to join the carnival she''s spent her entire life preparing for.', 10, 2);
-- Event 11
insert into Event ( name, description, mediaitem_id, category_id) values ( 'FIGEREO FLORENCIA','Get in touch with the stunning staccato and your inner Andalusian -- and put on your dancing shoes even if you''re just in the audience! It''s down to this one night of competition for the eight mesmerizing couples from around the globe that made it this far. Purchase VIP tickets to experience the competition and revel in the after-hours cabaret party with the world''s most alluring dancers!', 14, 2);
-- Event 12
insert into Event ( name, description, mediaitem_id, category_id) values ( 'FINT LAUTARO', 'It''s one night only for this once-in-a-lifetime concert-in-the-round with Grammy winning folk and blues legend Jesse Lewis. Entirely stripped of elaborate recording production, Lewis'' music stands entirely on its own and has audiences raving it''s his best work ever. With limited seating this final concert, don''t dare to miss this classic you can tell your grandkids about when they develop some real taste in music.', 15, 1);
-- Event 13
insert into Event ( name, description, mediaitem_id, category_id) values ( 'BURNS DANIELA', 'Make way for Puccini''s opera in three acts and wear waterproof mascara for the dramatic tearjerker of the season. Let the voice of renowned soprano Rosino Storchio and tenor Giovanni Zenatello envelop you under the stars while you sob quietly into your handkerchief! Wine and hard liquor will be available during intermission and after the show for those seeking to drown their sorrows.', 16, 2);
-- Event 14
insert into Event ( name, description, mediaitem_id, category_id) values ( 'QUEVEDO JOSE', 'Join in the region''s largest and most revered demonstration of one of the most mocked arts forms of all time. Stand in stunned silence while the masters of Mime Mania thrill with dramatic gestures that far surpass the now passé "Woman in a Glass Box." See the famous, "I have 10 fingers, don''t make me give you one!" and other favorites and be sure to enjoy the post-show silent auction.', 17, 2);
-- Event 15
insert into Event ( name, description, mediaitem_id, category_id) values ( 'ALMEIDA LUIS', 'This show is for all those who traded in Hemingway for the poetry of the Doors, but really can''t remember why.  Come see a dead ringer for Jim Morrison and let the despair envelop your soul as he quotes from his tragic mentor, "I believe in a prolonged derangement of the senses in order to obtain the unknown." But be advised: Leave your ganja at home, or leave with the Po-Po', 18, 1);
-- Event 16
insert into Event ( name, description, mediaitem_id, category_id) values ( 'TRONCOSO GLADIS', 'Join your fellow ballet enthusiasts for the National Ballet Company''s presentation of Tutu Tchai, a tribute to Pyotr Tchaikovsky''s and the expressive intensity revealed in his three most famous ballets: The Nutcracker, Swan Lake, and The Sleeping Beauty.', 19, 2);
-- Event 17
insert into Event ( name, description, mediaitem_id, category_id) values ( 'SING MANUEL', 'They''re out to prove it''s not all about the fights! Join your favorite members of the Canadian Women''s Hockey League as they compete for the title "Queen of the Slap Shot." Commonly believed to be hockey''s toughest shot to execute, the speed and accuracy of slap shots will be measured on the ice. Fan participation and response will determine any ties. Proceeds will benefit local area domestic violence shelters.', 20, 4);
-- Event 18
insert into Event ( name, description, mediaitem_id, category_id) values ( 'LLOVET GLORIA', 'BERON DE ASTRADA', 21, 4);
-- Event 19
insert into Event ( name, description, mediaitem_id, category_id) values ( 'SOTO NANCY', 'GRAL RAMIREZ', 22, 2);
